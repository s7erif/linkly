 ...
 *
 * This layout lives inside the (authenticated) route group so it only wraps
 * /admin, /admin/customers, /admin/orders, etc. — NOT /admin/login.
 *
 * Without the route group, the layout would also wrap /admin/login and redirect
 * unauthenticated users to /admin/login in an infinite loop (ERR_TOO_MANY_REDIRECTS).
 */
